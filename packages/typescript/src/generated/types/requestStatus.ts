...
/**
 * This interface was referenced by `RequestStatus`'s JSON-Schema
...
/**
 * This interface was referenced by `RequestStatus`'s JSON-Schema
 * via the `definition` "RequestState".
 */
export type RequestState = 'queued' | 'active' | 'complete' | 'failed';
...
/**
 * This interface was referenced by `RequestStatus`'s JSON-Schema
 * via the `definition` "TransportError".
 */
